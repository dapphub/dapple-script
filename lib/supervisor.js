...
class Supervisor {
  ...
  step(obj) {
    if(this.processState === '1.1') {
      ...
      if(( oldStep.type === 'new' || oldStep.type === 'txr' ) && oldStep.type === obj.type && oldStep.receipt.gasUsed !== obj.receipt.gasUsed ) {
        ...
        // console.log('----');
        // console.log(obj);
        console.log('WARN: Gas mismatch! Something went wrong!');
      }
      this.stateFormatter.incStep(obj);
    } else if(this.processState === '2.1') {
      this.stateFormatter.incStep(obj);
    }
  }
