...
module.exports = {
  ...
  performLibraryCall: function (runState, co, localOpts, cb) {
    ...
    runState.ds.libs[co.to].handlers[fabi.name](inputObject, (err, res) => {
    ...
    //
    // if(co.to === '0x0000000000000000000000000000000000000001') {
    ...
    // } else if(co.to === '0x0000000000000000000000000000000000000002') {
    //   console.log(params);
    // }
  },
